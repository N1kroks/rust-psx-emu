...
impl CPU {
    ...
    pub fn run(&mut self) {
        ...
        match instruction.opcode() {
            ...
            _ => {
                panic!("Unimplemented instruction: {:#08x}", instruction.as_bytes());
            }
        }
    ...
    fn store32(&self, address: u32, data: u32) {
        self.bus.store32(address, data)
    }
